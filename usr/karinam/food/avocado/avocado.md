...
> - 💚 Dużo jednonienasyconych tłuszczów, błonnika i potasu – porcja ½ owocu ≈ 200 kcal.  
> - 🍽️ Uniwersalne: pasty, sałatki, desery, a nawet zapiekanki.  
...
- ⚖️ **Masa referencyjna:** 250 g/sztuka, co ułatwia liczenie wartości odżywczych i planowanie porcji.  
...
> [!timeline] Oś historyczna
> - 🗿 <span style="color:#15803d">**7000–5000 p.n.e., Mezoameryka**</span> – pierwsze udomowienia w dolinach Meksyku i Gwatemali, później przejęte przez Majów i Azteków.[^ferrao]  
> - 🪶 <span style="color:#166534">**1520–1530**</span> – kronikarze hiszpańscy opisują „aguacate”, co otwiera drogę do Europy.[^ferrao]  
> - 🚢 <span style="color:#0d9488">**XIX w.**</span> – nasiona trafiają do Kalifornii i na Florydę, rozpoczynając krzyżówki prowadzące do odmiany Hass.[^ferrao]  
> - 🌍 <span style="color:#0369a1">**XX–XXI w.**</span> – rozwój plantacji w Izraelu, Hiszpanii i Peru, a także boom eksportowy do USA i UE.[^fao]

> [!timeline] Oś ewolucyjna
> - 🐘 <span style="color:#7c2d12">**2,6 mln – 11 tys. lat temu (Plejstocen)**</span> – mastodonty i inne megassaki połykały owoce w całości, roznosząc pestki i „projektując” dzisiejszy rozmiar nasion.[^janzen]  
> - 🔻 <span style="color:#9a3412">**ok. 11 tys. lat temu**</span> – wymieranie megafauny powoduje przerwę w naturalnym rozsiewaniu; gatunek pozostaje zależny od ludzi.[^janzen]  
> - 🌾 <span style="color:#b45309">**7–8 tys. lat temu**</span> – Majowie i Aztekowie zaczynają świadomą selekcję odmian o najlepszym smaku i pestkach łatwych do usuwania.[^ferrao]

> [!warning]- 🐘 Gatunek o włos od zapomnienia
...
- 💧 **Nawadnianie:** kroplowe linie utrzymują równomierną wilgotność i ograniczają choroby korzeni (Phytophthora cinnamomi); drenaż to absolutny priorytet.[^ferrao]  
- 📆 **Zbiory:** Meksyk zbiera praktycznie cały rok, Peru/Kenia od kwietnia do września, a Hiszpania między grudniem a majem – dzięki temu hurtownie mogą mieszać partie i utrzymać stały wolumen.[^fao]  
- 🚚 **Łańcuch dostaw:** owoce ścina się jako „mature green”, następnie dojrzewa w centrach dystrybucji przy 2–5 °C i kontroli etylenu, co pozwala zsynchronizować wysyłki do UE i USA.[^fao]  
- 🪴 **Lokalność vs. import:** europejskie plantacje zmniejszają ślad transportowy, ale muszą inwestować w retencję i odsalanie, żeby nie obciążać lokalnych zasobów wodnych; rolnicy coraz częściej łączą awokado z bananami lub marakują dla lepszego wykorzystania wody.[^ferrao]

## 4. Dane użytkowe i zdrowie
Szczegółowe „statystyki” awokado (wartości odżywcze, praktyki kulinarne, zakupowe i zdrowotne) przenieśliśmy do [[avocado/avocado_item.md|karty produktu]]. Dzięki temu główna notatka skupia się na historii i łańcuchu dostaw, a wszelkie tabele i tipy znajdziesz w jednym miejscu.

## ↩ Powiązania
- [[avocado/avocado_hass.md|Awokado Hass – przewodnik]] – pełny opis odmiany, na której bazuje przewodnik.
- [[avocado/avocado_item.md|Awokado – karta produktu]] – wartości odżywcze, wskazówki kuchenne i zdrowotne.
- [[avocado/avocado_dom.md|Awokado Hass w mieszkaniu]] – pipeline kiełkowania i sprzedaży sadzonek.
- [[avocado/avocado_float_dock.md|AvoFloat Dock]] – projekt uchwytu 3D wspierającego kiełkowanie.
...
[^ferrao]: Ferrão, J.E.M., *Fruits of Warm Climates*, 2021.
[^janzen]: Daniel H. Janzen, Paul S. Martin, „Neotropical anachronisms: the fruits the gomphotheres ate”, *Science*, 215(4528):19–27, 1982.
