...
- **CPU (Oryon):** 8 rdzeni = 2× do ~4.6 GHz + 6× do ~3.62 GHz.
- **GPU (Adreno):** render 3D, ray tracing, compute.
- **NPU (Hexagon):** INT4/INT8/FP16; przyspieszenia LLM/vision.
- **Pamięć/magazyn:** **LPDDR5X**, **UFS 4.0/4.1**.
- **Łączność:** modem 5G **X85**, **Wi‑Fi 7** (FastConnect 7900), BT, UWB.
- **Media/ISP:** Spectra/AVP; wideo pro/AI.
