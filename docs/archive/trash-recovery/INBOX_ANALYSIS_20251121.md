...
**Akcja**: → `docs/infra/references/`

#### ⚙️ Procesy i wykonawcy (→ business/)
- `proces operacyjny.md` - Proces operacyjny
- `wykonawca.md` - Dokumentacja wykonawcy

**Akcja**: → `business/processes/` (proces) i `business/vendors/` (wykonawca)
...
#### 💰 Płatności i biznes (→ business/)
- `payments.md` - Płatności
- `1Taat.md` - Projekt 1Taat

**Akcja**: → `business/Finanse/` i `archive/05_PROJECTS/`
...
#### 🎮 Grywalizacja i motywacja (→ business/Operacje/)
...
**Akcja**: → `business/Operacje/Gamification/`
...
mv "archive/Archives Inbox/DevOps_Methodology.md" business/methodologies/
mv "archive/Archives Inbox/PARA_Metodyka_SecondBrain.md" business/methodologies/
mv "archive/Archives Inbox/PARA_Metodyka_SecondBrain 1.md" business/methodologies/ 2>/dev/null || true
mv "archive/Archives Inbox/Strategia_Blitzscaling_Uniwersalna.md" business/methodologies/
mv "archive/Archives Inbox/Obsidian Dashboard.md" business/methodologies/
mv "archive/Archives Inbox/CopyCode_Cursor_Workflow.md" business/methodologies/
```
...
**References** (3 pliki):
```bash
mkdir -p docs/infra/references
mv "archive/Archives Inbox/Obsidian_Links.md" docs/infra/references/
mv "archive/Archives Inbox/ctrl_h_dolphin.md" docs/infra/references/
mv "archive/Archives Inbox/Study.md" docs/infra/references/
```

**Procesy i wykonawcy** (2 pliki):
```bash
mkdir -p business/processes business/vendors
mv "archive/Archives Inbox/proces operacyjny.md" business/processes/
mv "archive/Archives Inbox/wykonawca.md" business/vendors/
```
...
mv "projects/e-waste-workshop/Inbox/EWW_Motywacja_Grywalizacja.md" business/Operacje/Gamification/
```

**Finanse i projekty** (2 pliki):
```bash
mv "archive/Archives Inbox/payments.md" business/Finanse/
...
mv "projects/e-waste-workshop/Inbox/eww_weekly_dashboard_iso_w_45_03_09_11.md" docs/infra/dashboards/
```
