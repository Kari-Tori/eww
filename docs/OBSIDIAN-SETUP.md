...
### Folder Tagów
```
Tags/          → symlink do docs/tags/
docs/tags/     → faktyczna lokalizacja tag pages
```

**Dlaczego symlink?**
- Obsidian tworzy `Tags/` w root vault
- Chcemy mieć clean root directory
- Tagi trzymamy w `docs/tags/`
...
2. Symlink przekierowuje do `docs/tags/`
