---
title: "obsidian"
description: "Folder note dla obsidian"
...
> **Folder Note** - centralny index dla katalogu `obsidian/`

## 📋 Cel folderu

Katalog `obsidian` zawiera 0 plików i 0 podfolderów.
...
- ⬆️ [[wiki/wiki|wiki]] - Folder nadrzędny
- 🏠 [[docs/INDEX|INDEX]] - Główny index

---

**Lokalizacja:** `site/wiki/obsidian`  
