---
title: "stylesheets"
description: "Folder note dla stylesheets"
...
> **Folder Note** - centralny index dla katalogu `stylesheets/`

## 📋 Cel folderu

Katalog `stylesheets` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `site/assets/stylesheets`  
