...
Zobacz szczegółowe przewodniki:
- **[obsidian-plugins.md](./obsidian-plugins.md)** — 24 community plugins
- **[installed_pluggins.md](./installed_pluggins.md)** — 13 zainstalowanych pluginów z konfiguracją
