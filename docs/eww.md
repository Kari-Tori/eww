---
title: Eww
description: ♻️ E-Waste Workshop - Centrum recyklingu i refabrykacji
type: file
category: docs
filepath: docs/eww.md
color: green
author: jakubc
owner: jakubc
created: 2025-11-21
...
```dataview
TABLE WITHOUT ID
  ("**" + repo_size + "**") as "Wielkość",
  ("**" + repo_folders + "**") as "Foldery",
  ("**" + repo_files + "**") as "Pliki",
  ("**" + repo_markdown + "**") as "Markdown",
  ("**" + repo_scripts + "**") as "Bash"
WHERE file.name = "eww"
```

> [!info]- Szczegóły skanu
> - **Data skanu:** `= this.last_scan`
> - **Wersja:** `= this.version`
> - **Fizycznie:** `= this.repo_size` (z archiwami)
> - **W Git:** ~6-9 MB (bez usr/ i archive/)
> - **Pełny indeks:** [FULL-INDEX.md](../FULL-INDEX.md)
