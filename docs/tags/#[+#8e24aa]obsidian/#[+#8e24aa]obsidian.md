---
title: "#[+#8e24aa]obsidian"
description: "Folder note dla #[+#8e24aa]obsidian"
...
> **Folder Note** - centralny index dla katalogu `#[+#8e24aa]obsidian/`

## 📋 Cel folderu

Katalog `#[+#8e24aa]obsidian` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#8e24aa]obsidian`  
