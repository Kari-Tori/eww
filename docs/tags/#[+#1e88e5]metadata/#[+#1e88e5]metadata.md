---
title: "#[+#1e88e5]metadata"
description: "Folder note dla #[+#1e88e5]metadata"
...
> **Folder Note** - centralny index dla katalogu `#[+#1e88e5]metadata/`

## 📋 Cel folderu

Katalog `#[+#1e88e5]metadata` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#1e88e5]metadata`  
