---
title: "#[+#8e24aa]bash"
description: "Folder note dla #[+#8e24aa]bash"
...
> **Folder Note** - centralny index dla katalogu `#[+#8e24aa]bash/`

## 📋 Cel folderu

Katalog `#[+#8e24aa]bash` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#8e24aa]bash`  
