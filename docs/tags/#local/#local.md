---
title: "#local"
description: "Folder note dla #local"
...
> **Folder Note** - centralny index dla katalogu `#local/`

## 📋 Cel folderu

Katalog `#local` zawiera 0 plików i 0 podfolderów.
