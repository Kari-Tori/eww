---
title: "#[+#8e24aa]docs"
description: "Folder note dla #[+#8e24aa]docs"
...
> **Folder Note** - centralny index dla katalogu `#[+#8e24aa]docs/`

## 📋 Cel folderu

Katalog `#[+#8e24aa]docs` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#8e24aa]docs`  
