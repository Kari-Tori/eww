---
title: "#[+#1e88e5]index"
description: "Folder note dla #[+#1e88e5]index"
...
> **Folder Note** - centralny index dla katalogu `#[+#1e88e5]index/`

## 📋 Cel folderu

Katalog `#[+#1e88e5]index` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#1e88e5]index`  
