---
title: "#[+#1e88e5]icons"
description: "Folder note dla #[+#1e88e5]icons"
...
> **Folder Note** - centralny index dla katalogu `#[+#1e88e5]icons/`

## 📋 Cel folderu

Katalog `#[+#1e88e5]icons` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#1e88e5]icons`  
