---
title: "#[+#43a047]delivery"
description: "Folder note dla #[+#43a047]delivery"
...
> **Folder Note** - centralny index dla katalogu `#[+#43a047]delivery/`

## 📋 Cel folderu

Katalog `#[+#43a047]delivery` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#43a047]delivery`  
