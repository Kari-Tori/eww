---
title: "#[+#43a047]docs"
description: "Folder note dla #[+#43a047]docs"
...
> **Folder Note** - centralny index dla katalogu `#[+#43a047]docs/`

## 📋 Cel folderu

Katalog `#[+#43a047]docs` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#43a047]docs`  
