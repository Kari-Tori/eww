---
title: "#[+#1e88e5]scripts"
description: "Folder note dla #[+#1e88e5]scripts"
...
> **Folder Note** - centralny index dla katalogu `#[+#1e88e5]scripts/`

## 📋 Cel folderu

Katalog `#[+#1e88e5]scripts` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#1e88e5]scripts`  
