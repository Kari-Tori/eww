---
title: "#[+#ffb300]folder-note"
description: "Folder note dla #[+#ffb300]folder-note"
...
> **Folder Note** - centralny index dla katalogu `#[+#ffb300]folder-note/`

## 📋 Cel folderu

Katalog `#[+#ffb300]folder-note` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#ffb300]folder-note`  
