---
title: "#[+#5e35b1]core"
description: "Folder note dla #[+#5e35b1]core"
...
> **Folder Note** - centralny index dla katalogu `#[+#5e35b1]core/`

## 📋 Cel folderu

Katalog `#[+#5e35b1]core` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#5e35b1]core`  
