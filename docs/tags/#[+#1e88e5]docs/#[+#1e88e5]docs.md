---
title: "#[+#1e88e5]docs"
description: "Folder note dla #[+#1e88e5]docs"
...
> **Folder Note** - centralny index dla katalogu `#[+#1e88e5]docs/`

## 📋 Cel folderu

Katalog `#[+#1e88e5]docs` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#1e88e5]docs`  
