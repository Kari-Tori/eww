---
title: "#[+#8e24aa]playbooks"
description: "Folder note dla #[+#8e24aa]playbooks"
...
> **Folder Note** - centralny index dla katalogu `#[+#8e24aa]playbooks/`

## 📋 Cel folderu

Katalog `#[+#8e24aa]playbooks` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#8e24aa]playbooks`  
