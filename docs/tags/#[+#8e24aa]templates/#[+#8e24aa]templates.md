---
title: "#[+#8e24aa]templates"
description: "Folder note dla #[+#8e24aa]templates"
...
> **Folder Note** - centralny index dla katalogu `#[+#8e24aa]templates/`

## 📋 Cel folderu

Katalog `#[+#8e24aa]templates` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#8e24aa]templates`  
