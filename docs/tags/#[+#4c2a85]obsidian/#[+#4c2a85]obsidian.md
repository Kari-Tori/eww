---
title: "#[+#4c2a85]obsidian"
description: "Folder note dla #[+#4c2a85]obsidian"
...
> **Folder Note** - centralny index dla katalogu `#[+#4c2a85]obsidian/`

## 📋 Cel folderu

Katalog `#[+#4c2a85]obsidian` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#4c2a85]obsidian`  
