---
title: "#formatting"
description: "Folder note dla #formatting"
...
> **Folder Note** - centralny index dla katalogu `#formatting/`

## 📋 Cel folderu

Katalog `#formatting` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#formatting`  
