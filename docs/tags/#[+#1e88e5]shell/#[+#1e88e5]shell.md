---
title: "#[+#1e88e5]shell"
description: "Folder note dla #[+#1e88e5]shell"
...
> **Folder Note** - centralny index dla katalogu `#[+#1e88e5]shell/`

## 📋 Cel folderu

Katalog `#[+#1e88e5]shell` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#1e88e5]shell`  
