---
title: "#[+#8e24aa]tags"
description: "Folder note dla #[+#8e24aa]tags"
...
> **Folder Note** - centralny index dla katalogu `#[+#8e24aa]tags/`

## 📋 Cel folderu

Katalog `#[+#8e24aa]tags` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#8e24aa]tags`  
