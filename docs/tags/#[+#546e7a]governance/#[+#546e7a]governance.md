---
title: "#[+#546e7a]governance"
description: "Folder note dla #[+#546e7a]governance"
...
> **Folder Note** - centralny index dla katalogu `#[+#546e7a]governance/`

## 📋 Cel folderu

Katalog `#[+#546e7a]governance` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#546e7a]governance`  
