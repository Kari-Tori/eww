---
title: "#asset"
description: "Folder note dla #asset"
...
> **Folder Note** - centralny index dla katalogu `#asset/`

## 📋 Cel folderu

Katalog `#asset` zawiera 0 plików i 0 podfolderów.
