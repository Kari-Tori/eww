---
title: "#viewer"
description: "Folder note dla #viewer"
...
> **Folder Note** - centralny index dla katalogu `#viewer/`

## 📋 Cel folderu

Katalog `#viewer` zawiera 0 plików i 0 podfolderów.
