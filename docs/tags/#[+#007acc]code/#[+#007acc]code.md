---
title: "#[+#007acc]code"
description: "Folder note dla #[+#007acc]code"
...
> **Folder Note** - centralny index dla katalogu `#[+#007acc]code/`

## 📋 Cel folderu

Katalog `#[+#007acc]code` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#007acc]code`  
