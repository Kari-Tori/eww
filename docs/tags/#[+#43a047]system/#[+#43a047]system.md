---
title: "#[+#43a047]system"
description: "Folder note dla #[+#43a047]system"
...
> **Folder Note** - centralny index dla katalogu `#[+#43a047]system/`

## 📋 Cel folderu

Katalog `#[+#43a047]system` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#43a047]system`  
