---
title: "#neovim"
description: "Folder note dla #neovim"
...
> **Folder Note** - centralny index dla katalogu `#neovim/`

## 📋 Cel folderu

Katalog `#neovim` zawiera 0 plików i 0 podfolderów.
