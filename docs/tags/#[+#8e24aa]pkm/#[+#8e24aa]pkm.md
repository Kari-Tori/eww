---
title: "#[+#8e24aa]pkm"
description: "Folder note dla #[+#8e24aa]pkm"
...
> **Folder Note** - centralny index dla katalogu `#[+#8e24aa]pkm/`

## 📋 Cel folderu

Katalog `#[+#8e24aa]pkm` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `docs/tags/#[+#8e24aa]pkm`  
