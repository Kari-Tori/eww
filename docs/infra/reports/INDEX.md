...
> [!NOTE] Ikony i kolory
> Wszystkie odwołania do ikon Kubuntu/Code/Obsidian wykorzystują standard opisany w [docs/infra/assets/icons.md](docs/infra/assets/icons.md).
...
- [docs/infra/assets/icons.md](docs/infra/assets/icons.md) — standard ikon Kubuntu/Code/Obsidian.
- [docs/infra/wiki/kubuntu.md](docs/infra/wiki/kubuntu.md) — przewodnik systemowy (`🟦 Kubuntu`).
- [docs/infra/software/code/code.md](docs/infra/software/code/code.md) — konfiguracja `🧰 VS Code`.
- [docs/infra/software/obsidian/obsidian.md](docs/infra/software/obsidian/obsidian.md) — notatki `💠 Obsidian`.
