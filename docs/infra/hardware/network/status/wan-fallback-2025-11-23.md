...
> [!note] Stan historyczny
> Migawka z 2025-11-23; bieżący stan WAN nie był weryfikowany w tej sesji – odśwież przed użyciem runbooka.
...
- 📌 **Źródła prawdy:** [[docs/infra/hardware/network/network]], [[docs/infra/hardware/laptops/lenovo_y700/lenovo_y700]], [[docs/infra/hardware/mobile/phones/README]].
...
- **Dokumentacja:** [[docs/infra/hardware/network/garynet]] opisuje parametry i checklisty tego połączenia międzybudynkowego.
