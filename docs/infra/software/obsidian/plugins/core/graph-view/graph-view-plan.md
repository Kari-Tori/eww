...
**Struktura**:
```
docs/infra/software/obsidian/plugins/core/graph-view/
...
readonly OUTPUT="docs/infra/software/obsidian/plugins/core/graph-view/graph-stats.md"
readonly GRAPH_JSON=".obsidian/graph.json"
...
git add docs/infra/software/obsidian/plugins/core/graph-view/
