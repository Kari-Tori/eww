...
author: jakubc
title: "filepath: /home/karinam/git/eww/docs/infra/software/code/plugins/code_plugins_installed.md"
...
```bash
# filepath: /home/karinam/git/eww/docs/infra/software/code/plugins/code_plugins_installed.md
#!/usr/bin/env bash
set -euo pipefail
