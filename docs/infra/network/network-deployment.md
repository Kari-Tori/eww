...
- **GaryNet** — opisany w [[docs/infra/network/garynet]]. Po wpięciu do WAN1 reaguje natychmiast (nie wymaga ręcznego logowania).
...
5. **Dokumentacja & monitoring**
   - Uaktualnić [[docs/infra/status_sieci]] diagramem docelowej architektury.  
   - Dodać zadania w `status_sieci` i `core/workflow/infrastructure.md`.  
...
## 🔗 Powiązane dokumenty
- [[docs/infra/status_sieci]] — bieżący runbook tetheringu.  
- [[docs/infra/network/README]] — źródło prawdy o sieci.  
- [[docs/infra/network/garynet]] — opis połączenia między budynkami.  
...
- [ ] Po wdrożeniu zaktualizować wszystkie diagramy (status_sieci, network README, core workflow).  
