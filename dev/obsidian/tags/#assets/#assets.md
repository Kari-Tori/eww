...
> **Folder Note** - centralny index dla katalogu `#assetss/`

## 📋 Cel folderu

Katalog `#assetss` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `dev/obsidian/tags/#assetss`  
