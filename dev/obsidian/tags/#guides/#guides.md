...
> **Folder Note** - centralny index dla katalogu `#guidess/`

## 📋 Cel folderu

Katalog `#guidess` zawiera 0 plików i 0 podfolderów.
...
**Lokalizacja:** `dev/obsidian/tags/#guidess`  
