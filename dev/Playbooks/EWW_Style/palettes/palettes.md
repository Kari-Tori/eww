...
> **Folder Note** - centralny index dla katalogu `palettes/`

## 📋 Cel folderu

Katalog `palettes` zawiera 0 plików i 0 podfolderów.
...
- ⬆️ [[EWW_Style/EWW_Style|EWW_Style]] - Folder nadrzędny
- 🏠 [[docs/INDEX|INDEX]] - Główny index


**Lokalizacja:** `dev/Playbooks/EWW_Style/palettes`  
