#!/usr/bin/env bash
# File: scripts/find_copy_describe_plugins.sh
# Author: 
# Created: 
# Updated: 
# Description: bash
...
#  - kopiuje jego zawartość do docs/infra/software/code/plugins/installed_pluggins.md
...
#   OUTPUT_FILE = docs/infra/software/code/plugins/installed_pluggins.md
...
readonly OUTPUT_FILE="${2:-$PWD/docs/infra/software/code/plugins/installed_pluggins.md}"
