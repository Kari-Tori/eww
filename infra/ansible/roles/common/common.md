...
> **Folder Note** - centralny index dla katalogu `common/`

## 📋 Cel folderu

Katalog `common` zawiera 0 plików i 1 podfolderów.
...
**Lokalizacja:** `infra/ansible/roles/common`  
