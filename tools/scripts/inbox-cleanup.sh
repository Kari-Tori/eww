...
move_file "archive/Archives Inbox/DevOps_Methodology.md" "docs/methodologies/DevOps_Methodology.md"
move_file "archive/Archives Inbox/PARA_Metodyka_SecondBrain.md" "docs/methodologies/PARA_Metodyka_SecondBrain.md"
move_file "archive/Archives Inbox/PARA_Metodyka_SecondBrain 1.md" "docs/methodologies/PARA_Metodyka_SecondBrain_v2.md" || true
move_file "archive/Archives Inbox/Strategia_Blitzscaling_Uniwersalna.md" "docs/methodologies/Strategia_Blitzscaling_Uniwersalna.md"
move_file "archive/Archives Inbox/Obsidian Dashboard.md" "docs/methodologies/Obsidian_Dashboard.md"
move_file "archive/Archives Inbox/CopyCode_Cursor_Workflow.md" "docs/methodologies/CopyCode_Cursor_Workflow.md"
...
move_file "archive/Archives Inbox/Obsidian_Links.md" "docs/references/Obsidian_Links.md"
move_file "archive/Archives Inbox/ctrl_h_dolphin.md" "docs/references/ctrl_h_dolphin.md"
move_file "archive/Archives Inbox/Study.md" "docs/references/Study.md"
move_file "archive/Archives Inbox/proces operacyjny.md" "docs/references/proces_operacyjny.md"
move_file "archive/Archives Inbox/wykonawca.md" "docs/references/wykonawca.md"
...
move_file "projects/e-waste-workshop/Inbox/EWW_Motywacja_Grywalizacja.md" "bussiness/Operacje/Gamification/EWW_Motywacja_Grywalizacja.md"

echo ""
echo -e "${BLUE}💰 Etap 6: Finanse i projekty (2 pliki)${NC}"

mkdir -p bussiness/Finanse archive/05_PROJECTS/1Taat
move_file "archive/Archives Inbox/payments.md" "bussiness/Finanse/payments.md"
...
move_file "projects/e-waste-workshop/Inbox/eww_weekly_dashboard_iso_w_45_03_09_11.md" "docs/dashboards/eww_weekly_dashboard_w45.md"
...
echo ""
echo "📁 Nowa struktura:"
echo "  docs/methodologies/        - 6 plików (PARA, DevOps, Blitzscaling)"
echo "  docs/team/karinam/          - 4 pliki (profile, tips, bash)"
echo "  docs/team/                  - 1 plik (ADHD)"
echo "  docs/references/            - 5 plików"
echo "  docs/infra/architecture/    - 1 plik (Systems Deep Dive)"
echo "  docs/dashboards/            - 1 plik"
echo "  bussiness/Operacje/Gamification/ - 1 plik"
echo "  bussiness/Finanse/          - 1 plik"
